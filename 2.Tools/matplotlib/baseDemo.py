...
fig_2, ax = plt.subplots()  # a figure with a single Axes
fig_3, axs = plt.subplots(2, 2)  # a figure with a 2x2 grid of Axes
...
axs[0, 0].plot([1, 2, 3, 4], [0, 2, 3, 4])  # Plot some data on the axes.
axs[0, 1].plot([1, 2, 3, 4], [1, 2, 3, 4])  # Plot some data on the axes.
axs[1, 0].plot([1, 2, 3, 4], [2, 2, 3, 4])  # Plot some data on the axes.
axs[1, 1].plot([1, 2, 3, 4], [3, 2, 3, 4])  # Plot some data on the axes.
